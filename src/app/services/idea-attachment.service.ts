...
export class IdeaAttachmentService extends ItemsListService {
  ...
  query(params: { [key: string]: any }): Observable<ApiResponse> {
    let path = this.Location.getAbsoluteUrlApi(this.Auth.resolveAuthorizedPath('/topics/:topicId/ideations/:ideationId/ideas/:ideaId/attachments'), params);
  ...
  save(data: any) {
    let path = this.Location.getAbsoluteUrlApi('/api/users/self/topics/:topicId/ideations/:ideationId/ideas/:ideaId/attachments', data);
  ...
  update(data: any) {
    ...
    const path = this.Location.getAbsoluteUrlApi('/api/users/self/topics/:topicId/ideations/:ideationId/ideas/:ideaId/attachments/:attachmentId', data)
