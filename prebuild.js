...
const pathSettings = path.resolve(__dirname + '/src/assets/config/config.json');
const pathDistSettings = path.resolve(__dirname + '/dist/citizenos-fe/assets/config/config.json');
